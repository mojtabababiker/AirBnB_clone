...
class TestPlace(unittest.TestCase):
    ...
    def test_None_arg(self):
        ...
        place3 = Place(None)
        self.assertNotIn(None, place3.__dict__.values())
    ...
    def test_Place_to_dict(self):
        ...
        place.user_id = "7234-753223-18932"
        place.city_id = "9234-753223-18932"
        place.name = "jisook"
        place.description = "kang"
        place.number_rooms = 3
        place.number_bathrooms = 2
        place.max_guest = 5
        place.price_by_night = 120
        place.latitude = 2.25
        place.longitude = 2.50
        place.amenity_ids = ["123", "345", "678"]
        place.created_at = place.updated_at = time

        place_dict = {
            "__class__": "Place",
            "id": "1234-753223-18932",
            "user_id": "7234-753223-18932",
            "city_id": "9234-753223-18932",
            "name": "jisook",
            "description": "kang",
            "number_rooms": 3,
            "number_bathrooms": 2,
